...
public class Game 
{
    ...
    private void createRooms()
    {
        ...
        classroom = new Room("in a lecture classroom");
    ...
    {
        System.out.println();
        System.out.println("Welcome to the World of Uppsala University!");
        System.out.println("World of Uppsala University is a new, incredibly boring adventure game.");
